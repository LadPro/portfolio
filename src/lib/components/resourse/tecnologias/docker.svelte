    ...
    $: tamaext = innerWidth < 1024 ? '350' : '135';
  ...
  <button 
    ...
    <span style="{accion ? `width: ${tamaSVG}px`: `width: ${tamaext}px`}; background-color: #0b1121" class="flex items-center bg-rosa rounded-lg transition-all duration-300 ">
