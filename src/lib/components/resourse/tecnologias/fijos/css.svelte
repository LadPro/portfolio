    ...
    let colorFondo = '#2299F8'
    // let colorletra = '#fff'
    // let colordesplegable = '#2299F8'
    let colorfill = '#fff'
    let colorfill2 = '#2299F8'
