...
<footer class="footer py-10 px-[5%] color flex max-lg:flex-col text-neutral-content items-center h-fit lg:h-56 justify-center" style="background-color: {colorfondo}">
    <div>
      <p class="text-4xl lg:text-r3xl shrink-0 text-gray-300">Tambien puedes contactarme a travez de:</p>
    </div> 
    <div class="flex lg:basis-[500px]">
        ...
        <div class="lg:hidden flex flex-wrap gap-4 justify-center">
            ...
            <Miconodesplegable texto='linkedin.com/in/joeljmora'  link={"https://www.linkedin.com/in/joeljmora/"} colortxt={colorfondo} colordesp={cverde} tamaSVG=90 tamaext=410 tamaletra=25 fillcolor={colorfondo} svg={plin} viewbox="0 0 512 512" />
